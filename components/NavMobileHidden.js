...
const NavMobileHidden = (props) => {
	return (
		<div className={props.isMenuToggled ? style.navMobileDisplayed : style.navMobileHidden}>
			...
			<div className={style.mobileNavSocials}>
				<Facebook key="facebook" href="https://www.facebook.com/TecomaTwilightEthicalMarket/" />
				<Instagram key="instagram" href="https://www.instagram.com/tecomatwilightmarket/" />
			</div>
			{/* <Donate /> */}
		</div>
	);
